# PostApp
PostApp is going to be an IOS app built in SwiftUI with MVVM, Firebase (used for Login,Register, Database).

Aims and goals :
●	Postapp's main goal is to bring users together and give them a platform to communicate with one another and their following.
●	List all of your objectives in posts.
●	Make tiny chores to assist in achieving each objective.
●	Regularly assess progress.
●	Share your ideas and discover your friends profiles

Functions, that we have implemented:
●	Login Register
●	Upload images
●	Sidebar
●	Diary book feed
●	Like the posts, unlike the posts
●	User Profile:
1)	  Posts that user posted
2)	  Posts that user liked
●	User search
